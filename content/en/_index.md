...
weight: 1
description: >
  Documentation for the MailWizz 3.x REST API.
---

This is the documentation for the MailWizz 3.x API.

For MailWizz 2.x API documentation, please see this [link](/v2).
